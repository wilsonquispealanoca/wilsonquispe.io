...
function ArticleItemHome({ title, gradient, slug }) {
  return (
    <>
      <Link as={`/posts/${slug}`} href="/posts/[slug]">
        ...
        >
          <div className="flex flex-col justify-between p-4 dark:bg-[#111111] bg-white rounded-md h-full">
            <h3 className="font-semibold leading-normal text-lg pb-3 text-primary-text dark:text-primary-dark">
              {title}
            </h3>
...
export default ArticleItemHome;
