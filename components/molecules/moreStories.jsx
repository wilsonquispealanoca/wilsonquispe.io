...
export default function MoreStories({ posts }) {
  return (
    <section>
      <Navbar />
      <h1 className="font-averia text-primary-text dark:text-primary-dark mb-8 text-5xl md:text-7xl lg:mt-16">
        Todos los artículos
      </h1>
      <h2 className="text-xl font-light mb-14 dark:text-[#999]">
