  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center">
      <div className="bg-[#2c0e6c] p-6 rounded-xl max-w-sm w-full relative shadow-lg text-center text-white">
        ...
        <a href="binance://pay/link?code=1034993751" className="flex bg-yellow-400 hover:bg-yellow-500 text-black px-4 py-2 rounded-lg font-bold transition justify-center gap-2">
