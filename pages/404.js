    ...
    <div className="h-screen w-screen bg-[#14102c] flex items-center">
      <div className="flex flex-col md:flex-row items-center justify-center mx-auto">
        <div className="max-w-lg px-6">
          <div className="text-4xl lg:text-5xl text-brand-beige font-averia font-bold my-10 lg:mb-16">
            Parece que estás perdido
          </div>
          <p className="text-2xl md:text-3xl font-light text-brand-beige font-outfit mb-8 lg:mb-6">
